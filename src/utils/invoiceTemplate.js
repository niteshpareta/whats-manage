        ...
        <div class="address-section">
            <div class="bill-to">
                ...
                <div>
                    ...
                    <strong>GSTN: <span id="client_gstn">{{CLIENT_GSTN}}</span></strong><br>
        ...
        <table class="items-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="cgst-sgst" {{cgst_sgst_style}}>{{CGST_RATE}}</td>
                    <td class="text-right cgst-sgst" {{cgst_sgst_style}}>{{CGST_AMT}}</td>
                    <td class="cgst-sgst" {{cgst_sgst_style}}>{{SGST_RATE}}</td>
                    <td class="text-right cgst-sgst" {{cgst_sgst_style}}>{{SGST_AMT}}</td>
                    <td class="igst" {{igst_style}}>{{IGST_RATE}}</td>
